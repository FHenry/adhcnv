...
/**
 * 	\defgroup   acces42     Module MyModule
 *  \brief      acces42
 *
 *  \file       htdocs/custom/acces42/core/modules/modAcces42.class.php
 *  \ingroup    acces42
 *  \brief      Description and activation file for module acces42
 */
 ...
 */
class modadhcnv extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 858587444; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'adhcnv';
        ...
        $this->description = "adhcnv";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "adhcnv";
        $this->editor_name = 'adhcnv';
        $this->editor_url = 'http://www.leventousnaturiste.fr/';
        ...
        $this->langfiles = array("adhcnv@adhcnv");
